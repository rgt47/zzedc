...
# Used for nightly QC checks across full dataset with cross-visit and
...
#'
#' For rules like: "if visit == 'v2' then weight within 10 percent of \{visit='v1'\}.weight"
...
#' @param tolerance Percentage tolerance (e.g., 10 for +/-10 percent)
...
#' or reference other visit data with \code{\{visit='...'\}} syntax.
#'
