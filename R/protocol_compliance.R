...
#' @examples
#' \dontrun{
#' # Register the active protocol version against which
#' # subsequent visits and deviations will be linked.
#' create_protocol(
#'   protocol_id    = "DEP-001",
#'   protocol_version = "1.2",
#'   effective_date  = Sys.Date(),
#'   primary_endpoint = "PHQ-9 score change at week 12"
#' )
#' }
#' @export
...
#' @examples
#' \dontrun{
#' # Define a scheduled visit window in protocol days.
#' add_protocol_visit(
#'   protocol_id  = "DEP-001",
#'   visit_code   = "WK4",
...
#' @examples
#' \dontrun{
#' # Record a protocol deviation for IRB reporting.
#' create_protocol_deviation(
#'   subject_id     = "SUBJ-001",
#'   visit_code     = "WK4",
#'   deviation_type = "out_of_window",
#'   description    = "Visit completed on day 33; subject travel",
#'   severity       = "minor",
#'   reported_by    = "site_pi"
#' )
#' }
