...
#' log_account_lockout(
#'   username = "jdoe",
#'   reason = "3 failed attempts in 5 minutes",
...
#' log_role_change(
#'   user_id = "admin",
#'   target_user = "new_coordinator",
#'   old_role = "viewer",
#'   new_role = "data_entry",
#'   reason  = "Onboarded after IRB approval"
#' )
#' }
#' @export
...
#'   old_value = 30,
#'   new_value = 15,
#'   reason = "IRB-recommended tightening"
#' )
#' }
#' @export
...
#' # (e.g., during a monitoring visit).
#' rows <- search_audit_trail(
#'   user_id    = "new_coordinator",
