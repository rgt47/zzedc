...
#' @examples
#' \dontrun{
#' # Capture an adverse event. Use `upgrade_to_sae()` if it later
...
#' @examples
#' \dontrun{
#' # Promote an existing AE to SAE status (e.g., subject
#' # hospitalised). Locks the original AE record per CFR Part 11.
#' upgrade_to_sae(
#'   ae_id       = 17,
#'   sae_criterion = "hospitalisation",
#'   upgraded_by = "site_pi",
#'   upgrade_reason = "Admitted for observation 2026-04-22"
#' )
#' }
#' @export
