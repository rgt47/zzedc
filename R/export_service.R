...
#' @examples
#' \dontrun{
#' # Build a structured EDC snapshot (subjects, forms, audit) for
#' # transmission to a sponsor or DCC.
#' prepare_edc_export(
#'   output_dir = tempfile(),
#'   include_audit = TRUE
#' )
...
#' @examples
#' \dontrun{
#' # Generate a synthetic-data export for an analyst to develop
#' # their pipeline against without touching real PHI.
#' prepare_sample_export(
#'   output_dir = tempfile(),
#'   n_subjects = 50
#' )
#' }
...
#' @examples
#' \dontrun{
#' # Bundle the validation, audit, and quality reports for a
#' # DSMB meeting.
#' prepare_reports_export(
#'   output_dir = tempfile(),
#'   reports    = c("validation", "audit", "quality")
#' )
#' }
#' @keywords internal
...
#' @examples
#' \dontrun{
#' # Export one table to a single output file. CSV, Excel, JSON,
