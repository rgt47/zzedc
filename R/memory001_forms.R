...
#' Get MEMORY-001 Form Definitions
#'
#' Returns a list of form definitions for the MEMORY-001 study.
#'
#' @return List containing demographics_form, cognitive_form, and
#'   adverse_event_form definitions
#' @keywords internal
#' @export
get_memory001_forms <- function() {
  list(
    demographics = demographics_form,
    cognitive = cognitive_form,
    adverse_events = adverse_event_form
  )
}
