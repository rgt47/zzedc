...
#' # Initiate a Data Protection Impact Assessment for a new
#' # processing activity.
#' create_pia_assessment(
#'   activity_name = "Genomic data sharing with Site B",
#'   conducted_by  = "data_protection_officer",
...
#' # GDPR workflows write to the encrypted study database; see
#' # `?initialize_encrypted_database` for setup.
#' # Append a risk-assessment row to a Privacy Impact Assessment.
#' add_risk_assessment(
#'   pia_id        = 1,
#'   risk_category = "unauthorised_access",
#'   likelihood    = "low",
#'   impact        = "high",
#'   mitigation    = "AES-256 at-rest encryption + RBAC"
#' )
#' }
#' @export
