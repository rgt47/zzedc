...
# Test: init_crf_version creates required tables
local({
    setup_crfv_test_env()
...
# Test: init_crf_version is idempotent
local({
    setup_crfv_test_env()
...
# Test: get_crf_version_types returns valid types
local({
...
# Test: get_crf_version_statuses returns valid statuses
local({
...
# Test: get_crf_change_types returns valid types
local({
...
# Test: get_crf_change_categories returns valid categories
local({
...
# Test: create_crf_definition creates CRF successfully
local({
    setup_crfv_test_env()
    init_crf_version()
...
# Test: create_crf_definition validates required fields
local({
    setup_crfv_test_env()
...
# Test: create_crf_definition rejects duplicate codes
local({
    setup_crfv_test_env()
...
# Test: get_crf_definitions retrieves CRFs
local({
    setup_crfv_test_env()
...
# Test: lock_crf_definition locks CRF
local({
    setup_crfv_test_env()
...
# Test: lock_crf_definition validates lock_reason length
local({
    setup_crfv_test_env()
...
# Test: unlock_crf_definition unlocks CRF
local({
    setup_crfv_test_env()
...
# Test: create_crf_version creates version successfully
local({
    setup_crfv_test_env()
    init_crf_version()
...
# Test: create_crf_version validates required fields
local({
    setup_crfv_test_env()
...
# Test: create_crf_version validates version_type
local({
    setup_crfv_test_env()
...
# Test: create_crf_version rejects locked CRF
local({
    setup_crfv_test_env()
...
# Test: create_crf_version creates hash chain
local({
    setup_crfv_test_env()
...
# Test: get_crf_versions retrieves versions
local({
    setup_crfv_test_env()
...
# Test: update_crf_version_status updates status
local({
    setup_crfv_test_env()
...
# Test: update_crf_version_status validates status
local({
    setup_crfv_test_env()
...
# Test: log_crf_change logs change successfully
local({
    setup_crfv_test_env()
    init_crf_version()
...
# Test: log_crf_change validates change_type
local({
    setup_crfv_test_env()
...
# Test: log_crf_change validates change_category
local({
    setup_crfv_test_env()
...
# Test: log_crf_change stores old and new values
local({
    setup_crfv_test_env()
...
# Test: get_crf_change_log retrieves changes
local({
    setup_crfv_test_env()
...
# Test: get_crf_change_log filters by type
local({
    setup_crfv_test_env()
...
# Test: get_crf_full_history retrieves complete history
local({
    setup_crfv_test_env()
...
# Test: create_version_snapshot creates snapshot
local({
    setup_crfv_test_env()
    init_crf_version()
...
# Test: create_version_snapshot validates snapshot_type
local({
    setup_crfv_test_env()
...
# Test: get_version_snapshots retrieves snapshots
local({
    setup_crfv_test_env()
...
# Test: compare_crf_versions compares versions
local({
    setup_crfv_test_env()
    init_crf_version()
...
# Test: get_version_comparisons retrieves comparisons
local({
    setup_crfv_test_env()
...
# Test: get_crf_version_statistics returns statistics
local({
    setup_crfv_test_env()
    init_crf_version()
...
# Test: complete CRF version workflow works end-to-end
local({
    setup_crfv_test_env()
    init_crf_version()
