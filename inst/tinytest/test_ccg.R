...
# Test: init_ccg creates required tables
local({
    setup_ccg_test_env()
...
# Test: get_ccg_field_types returns valid types
local({
...
# Test: get_ccg_form_categories returns valid categories
local({
    categories <- get_ccg_form_categories()

    expect_equal(typeof(categories), "character")
...
# Test: get_ccg_form_statuses returns valid statuses
local({
...
# Test: get_ccg_visit_types returns valid visit types
local({
    visits <- get_ccg_visit_types()

    expect_equal(typeof(visits), "character")
...
# Test: create_ccg_form creates form successfully
local({
    setup_ccg_test_env()
    init_ccg()
...
# Test: create_ccg_form validates required fields
local({
    setup_ccg_test_env()
...
# Test: create_ccg_form validates category
local({
    setup_ccg_test_env()
...
# Test: create_ccg_form validates visit type
local({
    setup_ccg_test_env()
...
# Test: create_ccg_form rejects duplicate form_code
local({
    setup_ccg_test_env()
...
# Test: get_ccg_forms retrieves forms
local({
    setup_ccg_test_env()
    init_ccg()
...
# Test: get_ccg_forms filters by category
local({
    setup_ccg_test_env()
...
# Test: get_ccg_forms filters by status
local({
    setup_ccg_test_env()
...
# Test: update_ccg_form_status changes status
local({
    setup_ccg_test_env()
...
# Test: update_ccg_form_status validates status values
local({
    setup_ccg_test_env()
...
# Test: update_ccg_form_status sets approval fields for APPROVED
local({
    setup_ccg_test_env()
...
# Test: add_ccg_field adds field to form
local({
    setup_ccg_test_env()
    init_ccg()
...
# Test: add_ccg_field validates required parameters
local({
    setup_ccg_test_env()
...
# Test: add_ccg_field validates field_code
local({
    setup_ccg_test_env()
...
# Test: add_ccg_field validates field_type
local({
    setup_ccg_test_env()
...
# Test: add_ccg_field rejects nonexistent form
local({
    setup_ccg_test_env()
...
# Test: add_ccg_field rejects duplicate field_code in same form
local({
    setup_ccg_test_env()
...
# Test: add_ccg_field stores all field properties
local({
    setup_ccg_test_env()
...
# Test: get_ccg_fields retrieves fields in order
local({
    setup_ccg_test_env()
...
# Test: get_ccg_fields filters by section
local({
    setup_ccg_test_env()
...
# Test: update_ccg_field updates field properties
local({
    setup_ccg_test_env()
...
# Test: update_ccg_field requires at least one update
local({
    setup_ccg_test_env()
...
# Test: create_ccg_version creates version record
local({
    setup_ccg_test_env()
    init_ccg()
...
# Test: create_ccg_version validates required fields
local({
    setup_ccg_test_env()
...
# Test: create_ccg_version rejects nonexistent form
local({
    setup_ccg_test_env()
...
# Test: create_ccg_version updates form version
local({
    setup_ccg_test_env()
...
# Test: get_ccg_versions retrieves version history
local({
    setup_ccg_test_env()
...
# Test: approve_ccg_version approves version
local({
    setup_ccg_test_env()
...
# Test: generate_ccg creates TXT document
local({
    setup_ccg_test_env()
    init_ccg()
...
# Test: generate_ccg creates MD document
local({
    setup_ccg_test_env()
...
# Test: generate_ccg creates HTML document
local({
    setup_ccg_test_env()
...
# Test: generate_ccg validates required parameters
local({
    setup_ccg_test_env()
...
# Test: generate_ccg rejects nonexistent form
local({
    setup_ccg_test_env()
...
# Test: generate_ccg rejects form with no fields
local({
    setup_ccg_test_env()
...
# Test: generate_ccg includes SDTM mapping when requested
local({
    setup_ccg_test_env()
...
# Test: generate_ccg logs generation to database
local({
    setup_ccg_test_env()
...
# Test: get_ccg_statistics returns statistics
local({
    setup_ccg_test_env()
    init_ccg()
...
# Test: complete CCG workflow works end-to-end
local({
    setup_ccg_test_env()
    init_ccg()
...
# Test: CCG handles skip conditions correctly
local({
    setup_ccg_test_env()
    init_ccg()
...
# Test: CCG handles sections correctly in output
local({
    setup_ccg_test_env()
    init_ccg()
