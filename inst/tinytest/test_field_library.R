...
# Test: init_field_library creates required tables
local({
    setup_fl_test_env()
...
# Test: create_field_category creates category
local({
    setup_fl_test_env()
    init_field_library()
...
# Test: get_field_categories retrieves categories
local({
    setup_fl_test_env()
...
# Test: add_library_field adds field successfully
local({
    setup_fl_test_env()
    init_field_library()
...
# Test: add_library_field validates required fields
local({
...
# Test: add_library_field rejects duplicate codes
local({
    setup_fl_test_env()
...
# Test: add_library_field stores all properties
local({
    setup_fl_test_env()
...
# Test: get_library_fields retrieves fields
local({
    setup_fl_test_env()
...
# Test: get_library_fields filters by category
local({
    setup_fl_test_env()
...
# Test: get_library_fields filters by CDISC domain
local({
    setup_fl_test_env()
...
# Test: get_library_fields searches by term
local({
    setup_fl_test_env()
...
# Test: get_library_field retrieves single field
local({
    setup_fl_test_env()
...
# Test: get_library_field returns error for nonexistent
local({
    setup_fl_test_env()
...
# Test: update_library_field updates field
local({
    setup_fl_test_env()
...
# Test: update_library_field requires at least one update
local({
...
# Test: deactivate_library_field deactivates field
local({
    setup_fl_test_env()
...
# Test: record_field_usage records usage
local({
    setup_fl_test_env()
...
# Test: get_field_usage retrieves usage history
local({
    setup_fl_test_env()
...
# Test: load_cdisc_standard_fields loads CDISC fields
local({
    setup_fl_test_env()
    init_field_library()
...
# Test: get_field_library_statistics returns statistics
local({
    setup_fl_test_env()
...
# Test: complete field library workflow works end-to-end
local({
    setup_fl_test_env()
    init_field_library()
