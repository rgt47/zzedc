...
# Test: home_ui function generates correct structure
local({
    if (exists("home_ui")) local({
    ui_output <- zzedc:::home_ui("test_home")
...
# Test: home_ui contains proper bsicons
local({
    if (exists("home_ui")) local({
    ui_output <- zzedc:::home_ui("test_home")
    ui_html <- as.character(ui_output)
...
# Test: home_ui has correct responsive structure
local({
    if (exists("home_ui")) local({
    ui_output <- zzedc:::home_ui("test_home")
    ui_html <- as.character(ui_output)
...
# Test: home_ui includes security and compliance information
local({
    if (exists("home_ui")) local({
    ui_output <- zzedc:::home_ui("test_home")
    ui_html <- as.character(ui_output)
...
# Test: home_ui provides proper navigation guidance
local({
    if (exists("home_ui")) local({
    ui_output <- zzedc:::home_ui("test_home")
    ui_html <- as.character(ui_output)
...
# Test: home module server functions work correctly
local({
    if (exists("home_ui")) local({
...
# Test: home_ui contact information is present
local({
    if (exists("home_ui")) local({
    ui_output <- zzedc:::home_ui("test_home")
    ui_html <- as.character(ui_output)
...
# Test: home_ui includes documentation links
local({
    if (exists("home_ui")) local({
    ui_output <- zzedc:::home_ui("test_home")
    ui_html <- as.character(ui_output)
...
# Test: home_ui has proper accessibility attributes
local({
    if (exists("home_ui")) local({
    ui_output <- zzedc:::home_ui("test_home")
    ui_html <- as.character(ui_output)
...
# Test: home_ui follows bslib design patterns
local({
    if (exists("home_ui")) local({
    ui_output <- zzedc:::home_ui("test_home")
    ui_html <- as.character(ui_output)
...
# Test: home_ui namespace is properly applied
local({
    if (exists("home_ui")) local({
    ui_output <- zzedc:::home_ui("test_namespace")
    ui_html <- as.character(ui_output)
