...
# Test: database pool can be created and configured
local({
...
# Test: database pool handles basic operations
local({
...
# Test: database pool handles concurrent operations
local({
    # Create test pool
    test_pool <- pool::dbPool(
      drv = RSQLite::SQLite(),
...
# Test: database pool handles connection errors gracefully
local({
...
# Test: database pool configuration from config works
local({
...
# Test: database pool supports authentication table operations
local({
...
# Test: database pool handles transaction-like operations
local({
    test_pool <- pool::dbPool(
      drv = RSQLite::SQLite(),
      dbname = ":memory:",
...
# Test: database pool resource cleanup works
local({
...
# Test: database pool handles environment variable configuration
local({
