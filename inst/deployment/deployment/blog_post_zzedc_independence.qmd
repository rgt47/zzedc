...
Detailed instructions: See `vignettes/getting-started.Rmd`
...
Detailed instructions: See `deployment/AWS_DEPLOYMENT_GUIDE.md` or `vignettes/technical-lead-guide.Rmd (Chapter 8)`
...
**Start exploring**:
- **Solo researcher?** See `vignettes/getting-started.Rmd`
- **Team with AWS?** See `vignettes/technical-lead-guide.Rmd (Chapter 8)`
