#!/usr/bin/env Rscript
#
# Add test users to demonstration trial database
#
# Usage:
#   From package root: Rscript vignettes/demonstration-trial/scripts/02-add_users.R
...
salt <- "demonstration_trial_salt_2025"
