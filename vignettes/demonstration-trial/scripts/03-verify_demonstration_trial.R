#!/usr/bin/env Rscript
#
# Verify demonstration trial data
#
# Usage:
#   From package root: Rscript vignettes/demonstration-trial/scripts/03-verify_demonstration_trial.R
#   From scripts dir:  Rscript 03-verify_demonstration_trial.R
#
...
get_script_dir <- function() {
  ...
  for (cand in candidates) {
    if (file.exists(file.path(cand, "03-verify_demonstration_trial.R"))) {
