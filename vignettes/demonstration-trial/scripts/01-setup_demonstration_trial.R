#!/usr/bin/env Rscript
#
# Demonstration Clinical Trial Setup Script
# Creates complete ZZedc database with 20 subjects, randomization, and MMSE data
#
# Usage:
#   From package root: Rscript vignettes/demonstration-trial/scripts/01-setup_demonstration_trial.R
#   From scripts dir:  Rscript 01-setup_demonstration_trial.R
#

cat("Creating Demonstration Clinical Trial Database...\n")
cat("=========================================\n\n")
...
get_script_dir <- function() {
 ...
 # Fallback: check common locations
  candidates <- c(
    "vignettes/demonstration-trial/scripts",
    ".",
    file.path(getwd(), "vignettes/demonstration-trial/scripts")
  )
  for (cand in candidates) {
    if (file.exists(file.path(cand, "01-setup_demonstration_trial.R"))) {
...
db_path <- file.path(base_dir, "data", "demonstration_trial.db")
...
cat("Ready to launch ZZedc with demonstration trial data\n")
cat("=========================================\n")
