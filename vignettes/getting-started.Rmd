...
ZZedc is an Electronic Data Capture (EDC) system implemented in R/Shiny for managing clinical trial and research study data.

## System Components

The system includes the following functional components:

- Authentication system with user role management
- Web-based interface for data entry and management
- Data validation framework with customizable rules
- Reporting system for data summarization and quality assessment
- Multi-format data export capabilities
- Role-based access control for user permissions
- Regulatory compliance features supporting GCP and CFR Part 11 frameworks
...
# Clone the validation dependency (required)
git clone https://github.com/rgt47/zzedc-validation.git
```
...
### Step 3: Install ZZedc Packages

Install the packages in order (validation package first):

```{r installation}
# Install zzedc.validation (required dependency)
devtools::install("~/zzedc-project/zzedc-validation")
...
If you prefer not to clone locally:
...
packageVersion("zzedc.validation")
```
