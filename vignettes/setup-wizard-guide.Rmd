...
# Your browser opens; navigate to Admin Dashboard > Setup Wizard
```
...
A unique security salt has been generated for your system. **Save this in a secure place** — it encrypts all passwords.
...
**Checkbox**: Confirm that you have saved the security salt
...
**Start with ADHD Examples** ← Click this option
...
```
Success! Your ZZedc system has been created
```
...
In the **Admin Dashboard** → **👤 User Management**:
1. Click "Add User"
...
In the **Admin Dashboard** → **⚙️ System Configuration**:
...
- Or use Admin Dashboard → System Configuration
...
- **Admin Dashboard:** Click "Help & Documentation" tab

---

## Summary: What You Just Did

- Created a complete clinical trial data management system
...
**A:** Yes. Use Admin Dashboard → System Configuration to update study details.

### Q: What if my team grows?
**A:** Add new users anytime in User Management. No restart needed.

### Q: How do I backup my data?
**A:** Automatic backups run daily. Manual backups in Admin Dashboard → Backup & Restore.

### Q: Can I change passwords?
**A:** Yes. Users can change their own password. Admins can reset any user's password.

### Q: What if something goes wrong?
**A:** Restore from backup in Admin Dashboard → Backup & Restore. No data is lost.
...
[Launch ZZedc Now →](https://github.com/rgt47/zzedc)
