...
This vignette describes implementation of ZZedc for small-scale clinical studies (10-50 participants) with straightforward data collection requirements.

## Overview

This guide covers:

- Implementation procedures for small study teams
- Data entry workflow design
